...
<html lang="en">
    ...
    <body class="fix-header fix-sidebar card-no-border">
            ...
            <div class="page-wrapper">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">Model section Shipping, fees and VAT</h3>
                    </div>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <label>Shipping models</label>
                                    <div class="pull-right">
                                        <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModalNew">Create new shipping model</button>
                                    </div>
                                    ...
                                    <div class="table-responsive">
                                        <table id="data_table" class="table table-striped table-bordered">
                                            ...
                                            <tbody>
                                                @foreach ($modelshipping as $row)
                                                <tr>
                                                    <td>{{$row['warehousename']}}</td>
                                                    @if($row['fba'] == 1)
                                                    <td>{{$row['countryname']}} FBA</td>
                                                    @else 
                                                    ...
                                                    <td class='td-field'>
                                                        <span class="field-value">
                                                            @if(isset($row[$row['warehouseId'].'-'.$row['countryId']."-".$model->idmodelshipname]))
                                                                {{$row[$row['warehouseId'].'-'.$row['countryId']."-".$model->idmodelshipname]}}
                                                            @endif
                                                        </span>
                                                        <div class="field-edit">
                                                            <input type="text" name="valueships" class="number form-control" value="@if(isset($row[$row['warehouseId'].'-'.$row['countryId'].'-'.$model->idmodelshipname])){{$row[$row['warehouseId'].'-'.$row['countryId'].'-'.$model->idmodelshipname]}}@endif" 
                                                            data-field="valueship" data-title="modelshipping" data-warehouse="{{$row['warehouseId']}}" data-country="{{$row['countryId']}}" data-modelid="{{$model->idmodelshipname}}" data-fba="{{$row['fba']}}">
                                                        </div>
                                                    </td>
                                                    @endforeach
                                                </tr>
                                            ...
                                            <div class="modal-dialog modal-lg">
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h4 class="modal-title">Add new shipping model</h4>
                                                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                    </div>
                                                    <form method="post" action="addNewShippingModel" name="shipping_model_form" id="shipping_model_form" enctype="multipart/form-data">  
                                                        {{csrf_field()}}
                                                        <div class="modal-body">
                                                            <table class="table mt-4" border="1">
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <td><b>Name of new Model:</b></td>
                                                                        <td colspan="2"><input type="text" class="form-control" name="shipping_model_name" id="shipping_model_name" required=""></td>
                                                                    </tr>
                                                                    @foreach ($warehouses as $warehouse)
                                                                        <tr>
                                                                            <td colspan="3"><b>{{$warehouse->shortname}}</b></td>
                                                                        </tr>
                                                                        @foreach ($countrys as $country)
                                                                        <tr>
                                                                            <td colspan="2">{{$country->shortname}}</td>
                                                                            <td><input type="text" class="form-control number" name="warehouse_country_val[{{$warehouse->idwarehouse}}-{{$country->countryid}}]"></td>
                                                                        </tr>
                                                                        <input type="hidden" name="warehouse_country_ids[]" value="{{$warehouse->idwarehouse}}-{{$country->countryid}}">
                                                                        <tr>
                                                                            <td colspan="2">{{$country->shortname}} FBA</td>
                                                                            <td><input type="text" class="form-control number" name="warehouse_country_fba_val[{{$warehouse->idwarehouse}}-{{$country->countryid}}]"></td>
                                                                        </tr>
                                                                        <input type="hidden" name="warehouse_country_fba_ids[]" value="{{$warehouse->idwarehouse}}-{{$country->countryid}}">
                                                                        @endforeach
                                                                    @endforeach
                                                                    <button type="submit" name="send_shipping_model" class="btn-submit">Send</button>
                                                                </tbody>
                                                            </table>
                                                        </div>
                                                        <div class="modal-footer">
                    ...
                    <!-- Start Fees Model Content START -->
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <label>Fees models</label>
                                    <div class="pull-right">
                                        <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModalForFees">Create new fee model</button>
                                    </div>
                                    <div class="table-responsive">
                                        <table id="data_table_for_fees" class="table table-striped table-bordered">
                                            <thead>
                                                <tr>
                                                    <th>Channel</th>
                                                    @foreach ($modelfeesname as $key => $FeesModel)
                                                    <th>{{$FeesModel->name}}</th>
                                                    @endforeach
                                                </tr>
                                            </thead>
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class='td-field'>
                                                        ...
                                                        ?>
                                                        <span class="field-value">{{$channel->$idmodelfeesname}}</span>
                                                        <div class="field-edit">
                                                            <input type="text" name="valuefees" class="number form-control" value="{{$channel->$idmodelfeesname}}" data-id="{{$channel->$idmodelfeesId}}" 
                                                                data-field="valuefees" data-title="modelfees" data-modelid="{{$model->idmodelfeesname}}" data-channelid="{{$channel->idchannel}}">
                                                        </div>
                                                    </td>
                                                    @endforeach
                                                </tr>
                                    ...
                                    <div class="container">
                                        <div class="modal fade" id="myModalForFees" role="dialog">
                                            <div class="modal-dialog modal-lg">
                                                <style type="text/css">
                                                    .modal .modal-dialog .modal-header:before,
                                                    .modal .modal-dialog .modal-header:after {
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h4 class="modal-title">Add new fees models</h4>
                                                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                    </div>
                                                    <form action="addNewFeesModel" method="post" name="fees_model_form" id="fees_model_form" enctype="multipart/form-data">  
                                                        {{csrf_field()}}
                                                        <div class="modal-body">
                                                            <table class="table mt-4" border="1">
                                                                <thead>
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <td><b>Name of new Model:</b></td>
                                                                        <td><input type="text" class="form-control" name="fees_model_name" id="fees_model_name" required=""></td>
                                                                    </tr>
                                                                    @foreach ($channels as $key => $ch)
                                                                    <tr>
                                                                        <td>{{$ch->shortname}}</td>
                                                                        <td><input type="text" class="form-control number" name="channel_val[{{$ch->idchannel}}]" id="channel_val"></td>
                                                                    </tr>
                                                                    <input type="hidden" name="channel_ids[]" value="{{$ch->idchannel}}">
                                                                    @endforeach
                                                                    <button type="submit" name="send_fees_model" class="btn-submit">Send</button>
                                                                </tbody>
                                                            </table>
                                                        </div>
                                                        <div class="modal-footer">
                    ...
                    <!-- Start Fees Model Content END -->
                    <!-- Start Vat Model Content START -->
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <label>VAT models</label>
                                    <div class="pull-right">
                                        <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModalForVat">Create new VAT model</button>
                                    </div>
                                
                                    <div class="table-responsive">
                                        <table id="data_table_for_vat" class="table table-striped table-bordered">
                                            <thead>
                                                <tr>
                                                    <th>Country</th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class='td-field'>
                                                        ...
                                                        ?>
                                                        <span class="field-value">{{$country->$idmodelvatname}}</span>
                                                        <div class="field-edit">
                                                            <input type="text" name="valuevat" class="number form-control" value="{{$country->$idmodelvatname}}" data-id="{{$country->$idmodelvatId}}" 
                                                                data-field="valuevat" data-title="modelvat" data-modelid="{{$model->idmodelvatname}}" data-channelid="{{$country->countryid}}">
                                                        </div>
                                                    </td>
                                                    @endforeach
                                                </tr>
                                    ...
                                    <div class="container">
                                        <div class="modal fade" id="myModalForVat" role="dialog">
                                            <div class="modal-dialog modal-lg">
                                                <style type="text/css">
                                                    .modal .modal-dialog .modal-header:before,
                                                    .modal .modal-dialog .modal-header:after {
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h4 class="modal-title">Add New Fees Model</h4>
                                                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                    </div>
                                                    <form action="addNewVatModel" method="post" name="vat_model_form" id="vat_model_form" enctype="multipart/form-data">  
                                                        {{csrf_field()}}
                                                        <div class="modal-body">
                                                            <table class="table mt-4" border="1">
                                                                <thead>
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <td><b>Name of new Model:</b></td>
                                                                        <td><input type="text" class="form-control" name="vat_model_name" id="vat_model_name" required=""></td>
                                                                    </tr>
                                                                    @foreach ($countrys as $key => $country)
                                                                    <tr>
                                                                        <td>{{$country->longname}}</td>
                                                                        <td><input type="text" class="form-control number" name="country_val[{{$country->countryid}}]" id="country_val"></td>
                                                                    </tr>
                                                                    <input type="hidden" name="country_ids[]" value="{{$country->countryid}}">
                                                                    @endforeach
                                                                    <button type="submit" name="send_vat_model" class="btn-submit">Send</button>
                                                                </tbody>
                                                            </table>
                                                        </div>
                                                        <div class="modal-footer">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <label>Amazon shipping cost models</label>
                                    <div class="pull-right">
                                        <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModalForAmazonShippingCost">Create new Amazon Shipping Cost model</button>
                                    </div>
                                
                                    <div class="table-responsive">
                                        <table id="data_table_for_amazon_shipping_cost_model" class="table table-striped table-bordered">
                                            <thead>
                                                <tr>
                                                    <th>Channel</th>
                                            ...
                                            <tbody>
                                                @foreach ($shippingcostChannels as $key => $channel)
                                                <tr>
                                                    <td>{{$channel->shortname}}</td>
                                                    @foreach ($modelamazonshippingcostname as $key => $model)
                                                    <td class='td-field'>
                                                        ...
                                                        ?>
                                                        <span class="field-value">{{$channel->$amazonshippingcost}}</span>
                                                        <div class="field-edit">
                                                            <input type="text" name="shippingcost" class="number form-control" value="{{$channel->$amazonshippingcost}}" data-id="{{$channel->$modelamazonshippingcostId}}" 
                                                                data-field="shippingcost" data-title="modelamazonshippingcost" data-modelid="{{$model->amazonshippingcostmodelnameid}}" data-channelid="{{$channel->idchannel}}">
                                                        </div>
                                                    </td>
                                                    @endforeach
                                                </tr>
                                    ...
                                    <div class="container">
                                        <div class="modal fade" id="myModalForAmazonShippingCost" role="dialog">
                                            <div class="modal-dialog modal-lg">
                                                <style type="text/css">
                                                    .modal .modal-dialog .modal-header:before,
                                                    .modal .modal-dialog .modal-header:after {
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h4 class="modal-title">Add New New Amazon Shipping Cost Model</h4>
                                                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                    </div>
                                                    <form action="addNewAmazonShippingCostModel" method="post" name="shippingcost_model_form" id="shippingcost_model_form" enctype="multipart/form-data">  
                                                        {{csrf_field()}}
                                                        <div class="modal-body">
                                                            <table class="table mt-4" border="1">
                                                                <thead>
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <td><b>Name of new Model:</b></td>
                                                                        <td><input type="text" class="form-control" name="shippingcost_model_name" id="shippingcost_model_name" required=""></td>
                                                                    </tr>
                                                                    @foreach ($shippingcostChannels as $key => $ch)
                                                                    <tr>
                                                                        <td>{{$ch->shortname}}</td>
                                                                        <td><input type="text" class="form-control number" name="channel_val[{{$ch->idchannel}}]" id="channel_val"></td>
                                                                    </tr>
        ...
        <script>            
            $(document).ready(function() {
                ...
                $('.field-edit .form-control').change(function(event) {
                    ...
                    label.show();
                    var data  = {id:$(this).data('id'), field:$(this).data('field'), action:$(this).data('action'), value:$(this).val(), warehouse:$(this).data('warehouse'), country:$(this).data('country'), modelId:$(this).data('modelid'), fba:$(this).data('fba')};
        ...
        <script>
            ...
            $(document).ready(function() {
                $('#data_table_for_amazon_shipping_cost_model').DataTable();
            });
