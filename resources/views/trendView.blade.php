            ...
            <div class="page-wrapper">
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">View trends</h3>
                    </div>
                    <div class="col-md-7 align-self-center">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                            <li class="breadcrumb-item">pages</li>
                            <li class="breadcrumb-item active">View Trends</li>
                        </ol>
                    </div>
                </div>
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <a href="trendAddView" class="btn btn-info mr-3" style="float: left;">Create new trend</a>
                                    <div class="col-xs-12 table-responsive">
                                        ...
                                        <table id="myTable" class="table table-striped table-bordered" style="width: 100%;">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td class="td-field">
                                                        <span  class="field-value">{{$row['trendName']}}</span>
                                                        <div class="field-edit">
                                                            <input type="text" name="name" class="form-control" value="{{$row['trendName']}}" data-field="name">
                                                        </div>
                                                    </td>

                                                    @for($i=1; $i<54; $i++)
                                                        <td class="td-field">
                                                            <span  class="field-value">{{$row[$i]}}</span>
                                                            <div class="field-edit">
                                                                <input type="text" name="week_1" class="form-control" value="{{$row[$i]}}" data-week="{{$i}}" data-trend="{{$row['trendName']}}">
                                                            </div>
                                                        </td>
                                                    @endfor
                                                </tr>
        ...
        <script>
            $(document).ready(function() {
                ...
                $('.field-edit .form-control').change(function(event) {
                    ...
                    label.show();
                    var data={trendName:$(this).data('trend'),week:$(this).data('week') ,value:$(this).val()};
                    $.ajax({
                        url    : 'trendUpdate',
                        data   : data,
                        method : 'get',
