                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <form method="post" enctype="multipart/form-data" action="productAdd">
                                        {{ csrf_field() }}
                                        <div class="row">
                                            <div class="col-md-5 col-sm-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="bt-switch mb-10" style="width:140px;">
                                                        <input type="checkbox" name="active" checked data-on-color="info" value="1" data-off-color="success">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="nameshort" class="form-control" required/>
                                                </div>
                                                <div class="form-group">
                                                    <label>Long name</label>
                                                    <input type="text" name="namelong" class="form-control"/>
                                                </div>
                                                
                                                <div class="form-group">
                                                    <label>Buffer</label>
                                                    <input type="number" name="buffer" class="form-control" placeholder="Insert the quantity to have as buffer"/>
                                                </div>
                                                <div class="form-group">
                                                    <label>Target</label>
                                                    <input type="number" name="target" class="form-control" placeholder="Insert the wish quantity to sell every month"/>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="subcat" class="form-control">
                                                        ...
                                                        <option value="{{$row->Namesubcat}}">{{$row->Namesubcat}}</option>
                                                        @endforeach
                                                    </select>  
                                                </div><br>
                                                <div class="form-group">
                                                    <label>Time for order (in days)</label>
                                                    <input type="number" name="ordertime" class="form-control" placeholder="Insert time need to get the order (in days)" />
                                                </div>
                                                <div class="form-group">
                                                    <label>Selling time range (in weeks)</label>
                                                    <input type="number" name="orderrangetime" class="form-control" placeholder="Insert time range to sell the products (in weeks)" />
                                                </div>
                                                <div class="form-group">
                                                    <label>Notes</label>
                                                    <textarea name="description" class="form-control" rows="6" placeholder="Insert a comment for the product"></textarea>
                                                </div>
                                            </div>
                                            <!-- col-5 -->
                                            <div class="col-md-7 col-sm-12">
                                                <fieldset>
                                                    <table class="table table-bordered">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td><input type="text" name="asin" class="form-control" placeholder="Enter ASIN"></td>
                                                                <td><input type="text" name="ean" class="form-control" placeholder="Enter EAN"></td>
                                                ...
                                                <fieldset>
                                                    ...
                                                    <table class="table table-bordered">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td>Product</td>
                                                                <td><input type="text" name="Lengthcm" class="form-control" placeholder="In cm"></td>
                                                                <td><input type="text" name="Widthcm" class="form-control" placeholder="In cm"></td>
                                                                <td><input type="text" name="Heightcm" class="form-control" placeholder="In cm"></td>
                                                                <td><input type="text" name="Weightkg" class="form-control" placeholder="In kg"></td>
                                                            </tr>
                                                            <tr>
                                                                <td>Box</td>
                                                                <td><input type="text" name="Lengthcmbox" class="form-control" placeholder="In cm"></td>
                                                                <td><input type="text" name="Widthcmbox" class="form-control" placeholder="In cm"></td>
                                                                <td><input type="text" name="Heightcmbox" class="form-control" placeholder="In cm"></td>
                                                                <td><input type="text" name="Weightkgbox" class="form-control" placeholder="In kg"></td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                </fieldset><br>
                                                ...
                                                <div class="col-12 table-bordered">	
                                                    <div class="form-group">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-6">
                                                                <input type="number" name="itemsinpaket1" class="form-control" placeholder="Number of items in a parcel size S">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-6">
                                                                <input type="number" name="itemsinpaket2" class="form-control" placeholder="Number of items in a parcel size L">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-6">
                                                                <input type="number" name="itemsinpaket3" class="form-control" placeholder="Number of items in a parcel size XL">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div><br>
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        ...
                                                        <div class="form-group bt-switch mb-10" style="width:140px;">
                                                            ...
                                                            <input onchange="works()" type="checkbox" name="virtualkit" data-on-color="info" value="1" data-off-color="success" id="myCheck">
                                                        </div>
                                                        <table class="table table-bordered" id="showtable" style="display: none;">
                                                            <tbody>
                                                                <tr>
                                                                    <td><input type="text" name="pcs1" class="form-control" placeholder="Enter PCS 1"></td>
                                                                    <td>
                                                                        <select class="form-control" name="productid1">
                                                                            <option value="">Select ProductID 1</option>
                                                                            @foreach($products as $key => $row)
                                                                            <option value="{{$row->modelcode}}">{{$row->sku}}</option>
                                                                            @endforeach
                                                                        </select>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td><input type="text" name="pcs2" class="form-control" placeholder="Enter PCS 2"></td>
                                                                    <td>
                                                                ...
                                                                <tr>
                                                                    <td><input type="text" name="pcs3" class="form-control" placeholder="Enter PCS 3"></td>
                                                                    <td>
                                                                ...
                                                                <tr>
                                                                    <td><input type="text" name="pcs4" class="form-control" placeholder="Enter PCS 4"></td>
                                                                    <td>
                                                                ...
                                                                <tr>
                                                                    <td><input type="text" name="pcs5" class="form-control" placeholder="Enter PCS 5"></td>
                                                                    <td>
                                                                ...
                                                                <tr>
                                                                    <td><input type="text" name="pcs6" class="form-control" placeholder="Enter PCS 6"></td>
                                                                    <td>
                                                                ...
                                                                <tr>
                                                                    <td><input type="text" name="pcs7" class="form-control" placeholder="Enter PCS 7"></td>
                                                                    <td>
                                                                ...
                                                                <tr>
                                                                    <td><input type="text" name="pcs8" class="form-control" placeholder="Enter PCS 8"></td>
                                                                    <td>
                                                                ...
                                                                <tr>
                                                                    <td><input type="text" name="pcs9" class="form-control" placeholder="Enter PCS 9"></td>
                                                                    <td>
                                                        ...
                                                        <div id="showproductdetail">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="date" name="dateprice" class="form-control" value="<?php echo date('Y-m-d');?>"/>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control" name="manufacturerid">
                                                                    ...
                                                                    <option value="{{$row->manufacturerid}}">{{$row->shortname}}</option>
                                                                    @endforeach
                                                                </select>    
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Code</label>
                                                                <input type="text" name="codemanu" class="form-control" placeholder="Insert the code related to the manufacturer"/>
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Content</label>
                                                                <input type="text" name="content" class="form-control" placeholder="Insert the content in the box"/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <!-- col-6 -->
                                        ...
                                        <input type="submit" name="submit" class="btn btn-info pull-right" value="Save product in warehouse">
                                    </form>
                                </div>
                            </div>
                        </div>
