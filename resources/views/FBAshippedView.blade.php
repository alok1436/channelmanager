            ...
            <div class="page-wrapper">
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">View FBA ONTHEWAY</h3>
                    </div>
                    <div class="col-md-7 align-self-center">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                            <li class="breadcrumb-item">pages</li>
                            <li class="breadcrumb-item active">View FBA ONTHEWAY</li>
                        </ol>
                    </div>
                </div>
                                    ...
                                    <div class="col-xs-12 table-responsive">
                                        ...
                                        <table id="myTable" class="table table-striped table-bordered" style="width: 100%;">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>{{$row->SKU}}</td>
                                                    <td id="id_quantityNotArrived_{{$row->id}}">{{$row->quantityNotArrived}}</td>
                                                    <td class="td-field">
                                                        <span class="field-value">{{$row->quantityArrived}}</span>
                                                        <div class="field-edit">
                                                            <input type="text" name="quantityArrived" class="form-control" value="{{$row->quantityArrived}}" data-id="{{$row->id}}" data-field="quantityArrived">
                                                        </div>
                                                    </td>
                                                    <td>{{$row->date}}</td>
                                                    <td>
                                                        <input type="button" onclick="setArrived({{$row->id}})" class="btn btn-primary" value="Arrived" name="">
                                                        <input type="button" onclick="funccalldeletepopup({{$row->id}})" class="btn btn-danger" value="Delete" name="">
                                                    </td>
                                                </tr>
                                                @endforeach
                                            </tbody>
        ...
        <script>
            $(document).ready(function() {
                ...
                $('.field-edit .form-control').change(function(event) {
                    ...
                    var id = $(this).data('id');
                    $.ajax({
                        url    : 'fbaShippedUpdate',
                        data   : data,
                        method : 'get',
                        success: function(result) {
                            document.getElementById("id_quantityNotArrived_"+id).innerHTML = result;
                        }
                    });
                });
