            ...
            <div class="page-wrapper">
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">Vendor Blacklist</h3>
                    </div>
                    <div class="col-md-7 align-self-center">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                            <li class="breadcrumb-item">pages</li>
                            <li class="breadcrumb-item active">View Vendor Blacklist</li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <div class="col-sm-3">
                                        <a href="vendorblacklistaddview" class="btn btn-info btn-block send_courier">Insert item in blacklist</a>
                                    </div>
                                    ...
                                    <div class="col-xs-12 table-responsive">
                                        ...
                                        <table id="myTable" class="table table-striped table-bordered" style="width: 100%;">
                                            ...
                                            <tbody>
                                                @foreach ($vendorBlacklist as $key => $row)
                                                <tr>
                                                    <td>{{$row->idblacklist}}</td>
                                                    <td>{{$row->shortname}}</td>
                                                    <td>{{$row->sku}}</td>
                                                    <td>{{$row->eanvendor}}</td>
                                                    <td>{{$row->comment}}</td>
                                                    <td><a href="deletevendorblacklist/{{$row->idblacklist}}" class="btn btn-primary btn-default">DELETE</a></td>
                                                </tr>
                                                @endforeach
                                            </tbody>
                                        </table>
