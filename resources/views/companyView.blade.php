...
<html lang="en">
    ...
    <body class="fix-header fix-sidebar card-no-border">
            ...
            <div class="page-wrapper">
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">Company registered</h3>
                    </div>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <a href="companyAddView" class="btn btn-info">Add company</a>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="td-field">
                                                        ...
                                                        <div class="field-edit">
                                                            <input type="text" name="shortname" class="form-control" value="{{$row->shortname}}" data-id="{{$row->idcompany}}" data-field="shortname">
                                                        </div>
                                                    </td>
                                                    <td class="td-field">
                                                        <span  class="field-value">{{$row->longname}}</span>
                                                        <div class="field-edit">
                                                            <input type="text" name="longname" class="form-control" value="{{$row->longname}}" data-id="{{$row->idcompany}}" data-field="longname">
                                                        </div>
                                                    </td>
                                                    <td class="td-field">
                                                        <span  class="field-value">{{$row->street1}}</span>
                                                        <div class="field-edit">
                                                            <input type="text" name="street1" class="form-control" value="{{$row->street1}}" data-id="{{$row->idcompany}}" data-field="street1">
                                                        </div>
                                                    </td>
                                                    <td class="td-field">
                                                        <span  class="field-value">{{$row->street2}}</span>
                                                        <div class="field-edit">
                                                            <input type="text" name="street2" class="form-control" value="{{$row->street2}}" data-id="{{$row->idcompany}}" data-field="street2">
                                                        </div>
                                                    </td>
                                                    <td class="td-field">
                                                        <span  class="field-value">{{$row->plz}}</span>
                                                        <div class="field-edit">
                                                            <input type="text" name="plz" class="form-control" value="{{$row->plz}}" data-id="{{$row->idcompany}}" data-field="plz">
                                                        </div>
                                                    </td>
                                                    <td class="td-field">
                                                        <span  class="field-value">{{$row->city}}</span>
                                                        <div class="field-edit">
                                                            <input type="text" name="city" class="form-control" value="{{$row->city}}" data-id="{{$row->idcompany}}" data-field="city">
                                                        </div>
                                                    </td>
                                                    <td class="td-field">
                                                        <span  class="field-value">{{$row->province}}</span>
                                                        <div class="field-edit">
                                                            <input type="text" name="province" class="form-control" value="{{$row->province}}" data-id="{{$row->idcompany}}" data-field="province">
                                                        </div>
                                                    </td>
                                                    <td class="td-field">
                                                        <span  class="field-value">{{$row->country}}</span>
                                                        <div class="field-edit">
                                                            <input type="text" name="country" class="form-control" value="{{$row->country}}" data-id="{{$row->idcompany}}" data-field="country">
                                                        </div>
                                                    </td>
                                                    <td class="td-field">
                                                        <span  class="field-value">{{$row->phone}}</span>
                                                        <div class="field-edit">
                                                            <input type="text" name="phone" class="form-control" value="{{$row->phone}}" data-id="{{$row->idcompany}}" data-field="phone">
                                                        </div>
                                                    </td>
                                                    <td class="td-field">
                                                        <span  class="field-value">{{$row->fax}}</span>
                                                        <div class="field-edit">
                                                            <input type="text" name="fax" class="form-control" value="{{$row->fax}}" data-id="{{$row->idcompany}}" data-field="fax">
                                                        </div>
                                                    </td>
                                                    <td class="td-field">
                                                        <span  class="field-value">{{$row->email}}</span>
                                                        <div class="field-edit">
                                                            <input type="text" name="email" class="form-control" value="{{$row->email}}" data-id="{{$row->idcompany}}" data-field="email">
                                                        </div>
                                                    </td>
                                                    <td class="td-field">
                                                        <span  class="field-value">{{$row->fussnoteinvoice}}</span>
                                                        <div class="field-edit">
                                                            <input type="text" name="fussnoteinvoice" class="form-control" value="{{$row->fussnoteinvoice}}" data-id="{{$row->idcompany}}" data-field="fussnoteinvoice">
                                                        </div>
                                                    </td>
                                                    <td class="td-field">
                                                        <form action="uploadCompanyLogo" method="post" enctype="multipart/form-data">
                                                            {{csrf_field()}}
                                                            <input type="hidden" name="idcompany" class="form-control" value="{{$row->idcompany}}">
                                                            <span  class="field-value">
                                                                @if($row->linklogo != "")
                                                                <img src="assets/{{$row->linklogo}}" style="width: 50px;" alt="">
                                                                @endif
                                                            </span>
                                                            <div class="field-edit">
                                                                <input type="file" class="form-control" onchange="this.form.submit()" name="linklogo">
                                                            </div>
                                                        </form>
                                                    </td>
                                                    <td class="td-field">
                                                        <span  class="field-value" style="width: 150px; word-wrap: break-word !important; display: block;">{{substr($row->note,0,20)}}</span>
                                                        <div class="field-edit">
                                                            <textarea name="note" rows="10" class="form-control" data-id="{{$row->idcompany}}" style="width: 150px;" data-field="note">{{$row->note}}</textarea>
                                                        </div>
                                                    </td>
                                                    <td class="td-field">
                                                        <span  class="field-value" style="width: 150px; word-wrap: break-word !important; display: block;">{{substr($row->bankInformation,0,20)}}</span>
                                                        <div class="field-edit">
                                                            <textarea name="bankInformation" rows="10" class="form-control" data-id="{{$row->idcompany}}" style="width: 150px;" data-field="bankInformation">{{$row->bankInformation}}</textarea>
                                                        </div>
                                                    </td>
                                                    <td class="td-field">
                                                        <span  class="field-value" style="width: 150px; word-wrap: break-word !important; display: block;">{{substr($row->noteInvoice,0,20)}}</span>
                                                        <div class="field-edit">
                                                            <textarea name="noteInvoice" rows="10" class="form-control" data-id="{{$row->idcompany}}" style="width: 150px;" data-field="noteInvoice">{{$row->noteInvoice}}</textarea>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <a href="companyDelete?del={{$row->idcompany}}" class="btn btn-danger">Delete</a>
                                                    </td>
                                                </tr>
                                                @endforeach
                                            </tbody>
        ...
        <script>
            ...
            function uploadCompanyLogo(id_company) {
                document.getElementById("id_uploadCompanyLogo_"+id_company).submit();
            }
        </script>
