            ...
            <div class="page-wrapper">
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">Add new warehouse</h3>
                    </div>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <form method="post" action="warehouseAdd">
                                        {{ csrf_field() }}
                                        <div class="row">
                                            <div class="col-md-5 col-sm-12">
                                                ...
                                                <div class="form-group">
                                                    <label>Location of the warehouse</label>
                                                ...
                                                <div class="form-group">
                                                    <label>Note</label>
                                                    <textarea type="text" name="notes" class="form-control" placeholder="Write a comment" rows="5"></textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <input type="submit" name="btn-submit" class="btn btn-info" style="float: right;" value="Add new warehouse">
                                            </div>
                                        </div>
                                        <!-- row -->
                                    </form>
