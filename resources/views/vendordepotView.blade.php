            ...
            <div class="page-wrapper">
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">View platform available</h3>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <div class="col-sm-3">
                                        <a href="vendordepotAddView" class="btn btn-info btn-block send_courier">Add Vendordepot</a>
                                    </div>
                                    <div class="col-xs-12 table-responsive">
                                        <table id="myTable" class="table table-striped table-bordered" style="width: 100%;">
                                            ...
                                            <tbody>
                                                @foreach($vendordepot as $row)
                                                    <tr>
                                                        <td>{{$row->id}}</td>                    
                                                        <td class="td-field">
                                                            <span class="field-value">{{$row->location}}</span>
                                                            <div class="field-edit">
                                                                <input type="text" name="location" class="form-control" value="{{$row->location}}" data-id="{{$row->id}}" data-field="location">
                                                            </div>
                                                        </td>
                                                        <td class="td-field">
                                                            <span class="field-value">{{$row->description}}</span>
                                                            <div class="field-edit">
                                                                <input type="text" name="description" class="form-control" value="{{$row->description}}" data-id="{{$row->id}}" data-field="description">
                                                            </div>
                                                        </td>
                                                        <td class="td-field">
                                                            <span class="field-value">{{$row->address}}</span>
                                                            <div class="field-edit">
                                                                <input type="text" name="address" class="form-control" value="{{$row->address}}" data-id="{{$row->id}}" data-field="address">
                                                            </div>
                                                        </td>
                                                        <td class="td-field">
                                                            <span class="field-value">{{$row->city}}</span>
                                                            <div class="field-edit">
                                                                <input type="text" name="city" class="form-control" value="{{$row->city}}" data-id="{{$row->id}}" data-field="city">
                                                            </div>
                                                        </td>
                                                        <td class="td-field">
                                                            <span class="field-value">{{$row->region}}</span>
                                                            <div class="field-edit">
                                                                <input type="text" name="region" class="form-control" value="{{$row->region}}" data-id="{{$row->id}}" data-field="region">
                                                            </div>
                                                        </td>
                                                        <td class="td-field">
                                                            <span class="field-value">{{$row->plz}}</span>
                                                            <div class="field-edit">
                                                                <input type="text" name="plz" class="form-control" value="{{$row->plz}}" data-id="{{$row->id}}" data-field="plz">
                                                            </div>
                                                        </td>
                                                        <td class="td-field">
                                                            <span class="field-value">{{$row->longname}}</span>
                                                            <div class="field-edit">
                                                                <select name="country" class="form-control" data-id="{{$row->id}}" data-field="country">
                                                                    <option value="">Select blacklist</option>
                                                                    @foreach($countrys as $country)
                                                                    <option value="{{$country->countryid}}" @if($row->country == $country->countryid) selected @endif>{{$country->longname}}</option>
                                                                    @endforeach
                                                                </select>
                                                            </div>
                                                        </td>
