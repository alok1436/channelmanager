            ...
            <div class="page-wrapper">
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">Add new payment</h3>
                    </div>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <form method="post" action="paymentAdd">
                                        {{ csrf_field() }}
                                        <div class="row">
                                        ...
                                        <!-- row -->
                                        <input type="submit" name="submit-payment" value="Add new payment" class="btn btn-info pull-right">
                                    </form>
                                </div>
                            </div>
                        </div>
