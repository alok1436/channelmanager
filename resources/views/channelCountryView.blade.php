                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <a href="channelCountryAddView" class="btn btn-info">Add new returnId</a>
                                    <div class="col-xs-12 table-responsive" style="max-height: 700px;">
                                        <table id="myTable" class="table table-striped table-bordered" style="width: 100%;">
                                            ...
                                            <tbody>
                                                @foreach($channelCountry as $row)
                                                <tr>
                                                    <td class="td-field">
                                                        <span class="field-value">{{$row->shortname}}</span>
                                                        <div class="field-edit">
                                                            <select name="channelId" class="form-control" data-id="{{$row->id}}" data-field="channelId">
                                                                @foreach($channels as $channel)
                                                                    <option value="{{$channel->idchannel}}"
                                                                        @if($channel->idchannel==$row->channelId)
                                                                            selected=""
                                                                        @endif
                                                                        >
                                                                        <?php echo $channel->shortname; ?>
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                    ...
                                                    <td class="td-field">
                                                        ...
                                                        <div class="field-edit">
                                                            <input type="text" name="country" class="form-control" value="{{$row->country}}" data-id="{{$row->id}}" data-field="country">
                                                        </div>
                                                    </td>

                                                    <td class="td-field">
                                                        <span  class="field-value">{{$row->returnId}}</span>
                                                        <div class="field-edit">
                                                            <input type="text" name="returnId" class="form-control" value="{{$row->returnId}}" data-id="{{$row->id}}" data-field="returnId">
                                                        </div>
                                                    </td>
                                                    <td><a href="channelCountryDelete/{{$row->id}}" class="btn btn-danger">Delete</a></td>
                                                </tr>
                                                @endforeach
                                            </tbody>
                                        </table>
