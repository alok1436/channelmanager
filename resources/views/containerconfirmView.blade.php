                ...
                <div class="scroll-sidebar">
                    ...
                    <nav class="sidebar-nav">
                        <ul id="sidebarnav">
                            ...
                            <li> 
                                <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-credit-card-multiple"></i><span class="hide-menu">Supply W.H.</span></a>
                                <ul aria-expanded="false" class="collapse">
            ...
            <div class="page-wrapper">
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">Confirm arrival of orders</h3>
                    </div>
                    <div class="col-md-7 align-self-center">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                            <li class="breadcrumb-item">pages</li>
                            <li class="breadcrumb-item active">Confirm container arrived</li>
                        </ol>
                    </div>
                </div>
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <form action="confirmNewContainer" method="POST">
                                        {{ csrf_field() }}
                                        <div class="form-group">
                                            <label>Please select first the destination Warehouse of the order</label>
                                            ...
                                            <table id="myTable" class="table table-striped table-bordered" style="width: 100%;">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href="containerconfirmDelete?del_id={{$row->idnewcontainer}}" class="btn btn-danger">Delete</a></td>
                                                    </tr>
                                                    @endforeach
                                                </tbody>
                                            </table>
                                        ...
                                        <div class="form-group" style="float: right;">
                                            <input type="submit" name="transfer" value="Ok" class="btn btn-info">
                                        </div>
                                    </form>
                                </div>
                            </div>
