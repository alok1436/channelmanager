                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <a href="userAddView" class="btn btn-info">Add user</a>
                                        ...
                                        <table id="myTable" class="table table-striped table-bordered" style="width: 100%;">
                                            ...
                                            <tbody>
                                                ...
                                                <tr id="{{$row->userid}}">
                                                    ...
                                                    @if(count($users)>0)
                                                    <td>
                                                        <button class="btn btn-danger" style="cursor: pointer;" onclick="funccalldeletepopup('managedeletepopup','user','{{$row->userid}}','{{$rowdiv}}');">Delete</button>
                                                        <a href="userEditView?id={{$row->userid}}" class="btn btn-success" style="cursor: pointer;">Edit</a>
                                                    </td>
                                                    @endif
                                                </tr>
                                                @endforeach
