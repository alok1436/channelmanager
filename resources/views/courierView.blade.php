            ...
            <div class="page-wrapper">
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">Couriers available</h3>
                    </div>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    {{-- <a href="courierAddView" class="btn btn-info">Add currency</a> --}}
                                    <div class="col-xs-12 table-responsive">
                                        <table id="myTable" class="table table-striped table-bordered" style="width: 100%;">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>{{$row->shippingmodelid}}</td>                    
                                                    <td class="td-field">
                                                        <span  class="field-value">{{$row->shortname}}</span>
                                                        <div class="field-edit">
                                                            <input type="text" name="shortname" class="form-control" value="{{$row->shortname}}" data-id="{{$row->shippingmodelid}}" data-field="shortname">
                                                        </div>
                                                    </td>
                                                    <td>
                                                        @if($row->shortname == "SDA")
                                                    <button href="courierAddView" class="btn btn-info" data-toggle="modal" data-target="#sdaModal">Add</button>
                                                        @endif
                                                    </td>
                                                </tr>
                                                @endforeach
                ...
                <div class="modal fade" id="sdaModal" role="dialog" tabindex="-1">
                    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title">Set SDA</h4>
                            </div>
                            <form action="sdaCourierEdit" method="post">
                            {{csrf_field()}}
                            <div class="modal-body">
                                <table class="w-100">
                                    <tr>
                                        <td>VABPKB</td>
                                        <td>
                                            <input type="text" name="vabpkb" class="form-control" value="{{$sdaCourier->vabpkb}}">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>VABCCM</td>
                                        <td>
                                            <input type="text" name="vabccm" class="form-control" value="{{$sdaCourier->vabccm}}">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>VABCBO</td>
                                        <td>
                                            <input type="text" name="vabcbo" class="form-control" value="{{$sdaCourier->vabcbo}}">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>VABCTR</td>
                                        <td>
                                            <input type="text" name="vabctr" class="form-control" value="{{$sdaCourier->vabctr}}">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>VABTSP</td>
                                        <td>
                                            <input type="text" name="vabtsp" class="form-control" value="{{$sdaCourier->vabtsp}}">
                                        </td>
                                    </tr>
                                </table>
                            </div>
                            <div class="modal-footer">
                                ...
                                <button type="submit" class="btn btn-success" id="printDocument">Submit</button>
                            </div>
                            </form>
                        </div>
                    </div>
