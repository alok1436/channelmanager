                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <form method="post" enctype="multipart/form-data" action="updateGeneralSetting">
                                        {{ csrf_field() }}
                                        <div class="row">
                                            <!-- col-5 -->
                                            <div class="col-md-12">
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="avatar-wrapper" style="width: 80%; border-radius: 5px;">
                                                                @if($setting->main_background == "")
                                                                <img class="profile-pic" src="assets/images/upload_img.png" />
                                                                @else
                                                                <img class="profile-pic" src="assets/images/{{$setting->main_background}}" />
                                                                @endif
                                                                <div class="upload-button">
                                                                    <!-- <i class="fa fa-arrow-circle-up w-100" aria-hidden="true"></i> -->
                                                                </div>
                                                                <input name="main_background" type="file" id="id_main_background" class="form-control file-upload"><br/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="avatar-wrapper" style="width: 80%; border-radius: 5px;">
                                                                ...
                                                                <img class="profile-pic" src="assets/images/upload_img.png" />
                                                                @else
                                                                <img class="profile-pic" src="assets/images/{{$setting->logo2}}" />
                                                                @endif
                                                                <div class="upload-button">
                                                                    <!-- <i class="fa fa-arrow-circle-up w-100" aria-hidden="true"></i> -->
                                                                </div>
                                                                <input name="logo2" type="file" id="id_logo2" class="form-control file-upload"><br/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <!-- col-6 -->
                ...
                var readURL = function(input) {
                    ...
                    if (input.files && input.files[0]) {
                        ...
                        reader.onload = function (e) {
                            $(input).parent().find('.profile-pic').attr('src', e.target.result);
                        }
