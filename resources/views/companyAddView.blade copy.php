            ...
            <div class="page-wrapper">
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">Add new company</h3>
                    </div>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <form method="post" enctype="multipart/form-data" action="companyAdd">
                                        {{ csrf_field() }}
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-sm-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="avatar-wrapper">
                                                        ...
                                                        <input name="image" type="file" id="fileimg" class="form-control file-upload"><br/>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label>Note</label>
                                                        <textarea type="text" name="fussnoteinvoice" class="form-control" placeholder="Write a comment" rows="5"></textarea>
                                                </div>
                                        ...
                                        <!-- row -->
                                        <input type="submit" name="submit-company" class="btn btn-info pull-right" value="Add new company">
                                    </form>
                                </div>
                            </div>
                        </div>
