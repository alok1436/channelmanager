                ...
                <div class="modal-content">
                    <div class="" style="border-bottom:1px solid #e9ecef;padding:4px;padding-left:10px;padding-top:10px;">
                        <div style="float:left;">
                            <h4 class="">Delete <span id="deletetypetoshow"></h4>
                        </div>
                        ...
                        <ul id="sidebarnav">
                            ...
                            <li> 
                                ...
                                <ul aria-expanded="false" class="collapse">
                                    ...
                                    <li><a class="" href="view_payment.php">Payment</a></li>
            ...
            <div class="page-wrapper">
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">View Manufacturer</h3>
                    </div>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <a href="manufacturerAddView" class="btn btn-info">Add Manufacturer</a>
                                    <div class="col-xs-12">
                                        <table id="mytable" class="table table-striped table-bordered table-responsive">
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($manufacturer as $row) {
                                                    $rowdiv="manufacturer".$row->manufacturerid;
                                                ?>
                                                <tr id="<?=$rowdiv;?>">
                                                    <td><?php echo $row->manufacturerid; ?></td>
                                                    <td class="td-field">
                                                        <span  class="field-value"><?php echo $row->shortname; ?></span>
                                                        <div class="field-edit">
                                                            <input type="text" name="shortname" class="form-control" value="<?php echo $row->shortname; ?>" data-id="<?php echo $row->manufacturerid; ?>" data-field="shortname">
                                                        </div>
                                                    </td>
                                                    <td class="td-field">
                                                        <span  class="field-value"><?php echo $row->longname; ?></span>
                                                        <div class="field-edit">
                                                            <input type="text" name="longname" class="form-control" value="<?php echo $row->longname; ?>" data-id="<?php echo $row->manufacturerid; ?>" data-field="longname">
                                                        </div>
                                                    </td>
                                                    <td class="td-field">
                                                        <span  class="field-value"><?php echo $row->street1; ?></span>
                                                        <div class="field-edit">
                                                            <input type="text" name="street1" class="form-control" value="<?php echo $row->street1; ?>" data-id="<?php echo $row->manufacturerid; ?>" data-field="street1">
                                                        </div>
                                                    </td>
                                                    <td class="td-field">
                                                        <span  class="field-value"><?php echo $row->street2; ?></span>
                                                        <div class="field-edit">
                                                            <input type="text" name="street2" class="form-control" value="<?php echo $row->street2; ?>" data-id="<?php echo $row->manufacturerid; ?>" data-field="street2">
                                                        </div>
                                                    </td>
                                                    <td class="td-field">
                                                        <span  class="field-value"><?php echo $row->plz; ?></span>
                                                        <div class="field-edit">
                                                            <input type="text" name="plz" class="form-control" value="<?php echo $row->plz; ?>" data-id="<?php echo $row->manufacturerid; ?>" data-field="plz">
                                                        </div>
                                                    </td>
                                                    <td class="td-field">
                                                        <span  class="field-value"><?php echo $row->city; ?></span>
                                                        <div class="field-edit">
                                                            <input type="text" name="city" class="form-control" value="<?php echo $row->city; ?>" data-id="<?php echo $row->manufacturerid; ?>" data-field="city">
                                                        </div>
                                                    </td>
                                                    <td class="td-field">
                                                        <span  class="field-value"><?php echo $row->province; ?></span>
                                                        <div class="field-edit">
                                                            <input type="text" name="province" class="form-control" value="<?php echo $row->province; ?>" data-id="<?php echo $row->manufacturerid; ?>" data-field="province">
                                                        </div>
                                                    </td>
                                                    <td class="td-field">
                                                        <span  class="field-value"><?php echo $row->country; ?></span>
                                                        <div class="field-edit">
                                                            <input type="text" name="country" class="form-control" value="<?php echo $row->country; ?>" data-id="<?php echo $row->manufacturerid; ?>" data-field="country">
                                                        </div>
                                                    </td>
                                                    <td class="td-field">
                                                        <span  class="field-value"><?php echo $row->contact1; ?></span>
                                                        <div class="field-edit">
                                                            <input type="text" name="contact1" class="form-control" value="<?php echo $row->contact1; ?>" data-id="<?php echo $row->manufacturerid; ?>" data-field="contact1">
                                                        </div>
                                                    </td>
                                                    <td class="td-field">
                                                        <span  class="field-value"><?php echo $row->contact2; ?></span>
                                                        <div class="field-edit">
                                                            <input type="text" name="contact2" class="form-control" value="<?php echo $row->contact2; ?>" data-id="<?php echo $row->manufacturerid; ?>" data-field="contact2">
                                                        </div>
                                                    </td>
                                                    <td class="td-field">
                                                        <span  class="field-value"><?php echo $row->contact3; ?></span>
                                                        <div class="field-edit">
                                                            <input type="text" name="contact3" class="form-control" value="<?php echo $row->contact3; ?>" data-id="<?php echo $row->manufacturerid; ?>" data-field="contact3">
                                                        </div>
                                                    </td>
                                                    <td class="td-field">
                                                        <span  class="field-value"><?php echo $row->phone1; ?></span>
                                                        <div class="field-edit">
                                                            <input type="text" name="phone1" class="form-control" value="<?php echo $row->phone1; ?>" data-id="<?php echo $row->manufacturerid; ?>" data-field="phone1">
                                                        </div>
                                                    </td>
                                                    <td class="td-field">
                                                        <span  class="field-value"><?php echo $row->phone2; ?></span>
                                                        <div class="field-edit">
                                                            <input type="text" name="phone2" class="form-control" value="<?php echo $row->phone2; ?>" data-id="<?php echo $row->manufacturerid; ?>" data-field="phone2">
                                                        </div>
                                                    </td>
                                                    <td class="td-field">
                                                        <span  class="field-value"><?php echo $row->phone3; ?></span>
                                                        <div class="field-edit">
                                                            <input type="text" name="phone3" class="form-control" value="<?php echo $row->phone3; ?>" data-id="<?php echo $row->manufacturerid; ?>" data-field="phone3">
                                                        </div>
                                                    </td>
                                                    <td class="td-field">
                                                        <span  class="field-value"><?php echo $row->email1; ?></span>
                                                        <div class="field-edit">
                                                            <input type="text" name="email1" class="form-control" value="<?php echo $row->email1; ?>" data-id="<?php echo $row->manufacturerid; ?>" data-field="email1">
                                                        </div>
                                                    </td>
                                                    <td class="td-field">
                                                        <span  class="field-value"><?php echo $row->email2; ?></span>
                                                        <div class="field-edit">
                                                            <input type="text" name="email2" class="form-control" value="<?php echo $row->email2; ?>" data-id="<?php echo $row->manufacturerid; ?>" data-field="email2">
                                                        </div>
                                                    </td>
                                                    <td class="td-field">
                                                        <span  class="field-value"><?php echo $row->email3; ?></span>
                                                        <div class="field-edit">
                                                            <input type="text" name="email3" class="form-control" value="<?php echo $row->email3; ?>" data-id="<?php echo $row->manufacturerid; ?>" data-field="email3">
                                                        </div>
                                                    </td>
                                                    <td class="td-field">
                                                        <span  class="field-value"><?php echo $row->note1; ?></span>
                                                        <div class="field-edit">
                                                            <input type="text" name="note1" class="form-control" value="<?php echo $row->note1; ?>" data-id="<?php echo $row->manufacturerid; ?>" data-field="note1">
                                                        </div>
                                                    </td>
                                                    <td class="td-field">
                                                        <span  class="field-value"><?php echo $row->note2; ?></span>
                                                        <div class="field-edit">
                                                            <input type="text" name="note2" class="form-control" value="<?php echo $row->note2; ?>" data-id="<?php echo $row->manufacturerid; ?>" data-field="note2">
                                                        </div>
                                                    </td>
                                                    <td class="td-field">
                                                        <span  class="field-value"><?php echo $row->note3; ?></span>
                                                        <div class="field-edit">
                                                            <input type="text" name="note3" class="form-control" value="<?php echo $row->note3; ?>" data-id="<?php echo $row->manufacturerid; ?>" data-field="note3">
                                                        </div>
                                                    </td>
                                                    <td class="btn btn-danger" style="cursor: pointer;" onclick="funccalldeletepopup('managedeletepopup','manufacturer','<?=$row->manufacturerid;?>','<?=$rowdiv;?>');">Delete</td>
                                                </tr>
                                                <?php  } ?>
                                            </tbody>
                                        </table>
