                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <a href="paymentAddView" class="btn btn-info">Add new payment</a>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="td-field">
                                                        ...
                                                        <div class="field-edit">
                                                            <input type="text" name="shortname" class="form-control" value="{{$row->shortname}}" data-id="{{$row->idpayment}}" data-field="shortname">
                                                        </div>
                                                    </td>
                                                    <td class="td-field">
                                                        <span class="field-value">{{$row->longname}}</span>
                                                        <div class="field-edit">
                                                            <input type="text" name="longname" class="form-control" value="{{$row->longname}}" data-id="{{$row->idpayment}}" data-field="longname">
                                                        </div>
                                                    </td>
                                                    <td>
                                                        @if(session()->has('idpayment'))
                                                            @if($row->idpayment == session()->get('idpayment'))
                                                            <a href="paymentDelete?del={{$row->idpayment}}" class="btn btn-danger">Delete</a>
                                                            @endif
                                                        @endif
                                                    </td>
                                                </tr>
