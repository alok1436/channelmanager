            ...
            <div class="page-wrapper">
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">View main categories available</h3>
                    </div>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <a href="categoryAddView" class="btn btn-info">Add category</a>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="td-field">
                                                        ...
                                                        <div class="field-edit">
                                                            <input type="text" name="Namecat" class="form-control" value="{{$row->Namecat}}" data-id="{{$row->catmainid}}" data-field="Namecat">
                                                        </div>
                                                    </td>
                                                    <td class="td-field">
                                                        <span  class="field-value">{{$row->Descriptioncat}}</span>
                                                        <div class="field-edit">
                                                            <input type="text" name="Descriptioncat" class="form-control" value="{{$row->Descriptioncat}}" data-id="{{$row->catmainid}}" data-field="Descriptioncat">
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <a href="categoryDelete?del={{$row->catmainid}}" class="btn btn-danger">Delete</a>
                                                    </td>
                                                </tr>
                                                @endforeach
                                            </tbody>
