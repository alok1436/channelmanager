            ...
            <div class="page-wrapper">
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">SoldWeekly</h3>
                    </div>
                    <div class="col-md-7 align-self-center">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                            <li class="breadcrumb-item">pages</li>
                            <li class="breadcrumb-item active">View SoldWeekly</li>
                        </ol>
                    </div>
                </div>
                                        ...
                                        <table id="myTable" class="table table-striped table-bordered" style="width: 100%;">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <?php
                                                        $rem = 1;
                                                        if ($main_week_sell > 26) {
                                                            $rem = $main_week_sell - 26;
                                                            $rem++;
                                                        }
                                                        for ($i=$main_week_sell; $i>=$rem; $i--) { 
                                                            ?>

                                                            <th>Total sold weekly</th>
                                                            <?php foreach ($warehouses as $key => $w): ?>
                                                                <th>Weekell: <?php echo $i." : ".$w->location; ?></th>
                                                            <?php endforeach ?>
                                                            <?php
                                                        }
                                                    ?>                                                    
