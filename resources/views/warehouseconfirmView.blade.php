            ...
            <div class="page-wrapper">
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">Confirmation of tranfer items</h3>
                    </div>
                    <div class="col-md-7 align-self-center">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                            <li class="breadcrumb-item">pages</li>
                            <li class="breadcrumb-item active">Warehouse transfer confirm</li>
                        </ol>
                    </div>
                </div>
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <form action="transferWarehouse" method="POST">
                                        {{ csrf_field() }}
                                            ...
                                            <table id="myTable" class="table table-striped table-bordered" style="width: 100%;">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{$row->quantity}}</td>
                                                        <td><input type="text" class="form-control" name="idtransfer[{{$row->idtransfer}}]" value="{{$row->quantity}}"></td>
                                                        <td><a href="warehouseconfirmDel?del_id={{$row->idtransfer}}" class="btn btn-danger">Delete</a></td>
                                                    </tr>
                                                    @endforeach
                                                </tbody>
                                            </table>
