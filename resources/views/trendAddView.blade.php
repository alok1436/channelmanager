            ...
            <div class="page-wrapper">
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">Add trend</h3>
                    </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="col-xs-12 table-responsive">
                                        ...
                                        <form action="trendAdd" method="post">
                                            {{csrf_field()}}
                                            <button type="submit" class="btn btn-info mr-3" style="float: left;">Create new trend</button>
                                            <table id="myTable" class="table table-striped table-bordered" style="width: 100%;">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <div>
                                                                <input type="text" class="form-control" name="trendName" required="">
                                                            </div>
                                                        </td>
                
                                                        <td>
                                                            <div>
                                                                <input type="text" class="form-control" name="week_1" >
                                                            </div>
                                                        </td>
                
                                                        <td>
                                                            <div>
                                                                <input type="text" class="form-control" name="week_2" >
                                                            </div>
                                                        </td>

                                                        <td>
                                                            <div>
                                                                <input type="text" class="form-control" name="week_3" >
                                                            </div>
                                                        </td>
                
                                                        <td>
                                                            <div>
                                                                <input type="text" class="form-control" name="week_4" >
                                                            </div>
                                                        </td>

                                                        <td>
                                                            <div>
                                                                <input type="text" class="form-control" name="week_5" >
                                                            </div>
                                                        </td>
                
                                                        <td>
                                                            <div>
                                                                <input type="text" class="form-control" name="week_6" >
                                                            </div>
                                                        </td>

                                                        <td>
                                                            <div>
                                                                <input type="text" class="form-control" name="week_7" >
                                                            </div>
                                                        </td>
                
                                                        <td>
                                                            <div>
                                                                <input type="text" class="form-control" name="week_8" >
                                                            </div>
                                                        </td>

                                                        <td>
                                                            <div>
                                                                <input type="text" class="form-control" name="week_9" >
                                                            </div>
                                                        </td>
                
                                                        <td>
                                                            <div>
                                                                <input type="text" class="form-control" name="week_10" >
                                                            </div>
                                                        </td>

                                                        <td>
                                                            <div>
                                                                <input type="text" class="form-control" name="week_11" >
                                                            </div>
                                                        </td>
                
                                                        <td>
                                                            <div>
                                                                <input type="text" class="form-control" name="week_12" >
                                                            </div>
                                                        </td>

                                                        <td>
                                                            <div>
                                                                <input type="text" class="form-control" name="week_13" >
                                                            </div>
                                                        </td>
                
                                                        <td>
                                                            <div>
                                                                <input type="text" class="form-control" name="week_14" >
                                                            </div>
                                                        </td>

                                                        <td>
                                                            <div>
                                                                <input type="text" class="form-control" name="week_15" >
                                                            </div>
                                                        </td>
                
                                                        <td>
                                                            <div>
                                                                <input type="text" class="form-control" name="week_16" >
                                                            </div>
                                                        </td>

                                                        <td>
                                                            <div>
                                                                <input type="text" class="form-control" name="week_17" >
                                                            </div>
                                                        </td>
                
                                                        <td>
                                                            <div>
                                                                <input type="text" class="form-control" name="week_18" >
                                                            </div>
                                                        </td>

                                                        <td>
                                                            <div>
                                                                <input type="text" class="form-control" name="week_19" >
                                                            </div>
                                                        </td>
                
                                                        <td>
                                                            <div>
                                                                <input type="text" class="form-control" name="week_20" >
                                                            </div>
                                                        </td>

                                                        <td>
                                                            <div>
                                                                <input type="text" class="form-control" name="week_21" >
                                                            </div>
                                                        </td>
                
                                                        <td>
                                                            <div>
                                                                <input type="text" class="form-control" name="week_22">
                                                            </div>
                                                        </td>

                                                        <td>
                                                            <div>
                                                                <input type="text" class="form-control" name="week_23" >
                                                            </div>
                                                        </td>
                
                                                        <td>
                                                            <div>
                                                                <input type="text" class="form-control" name="week_24" >
                                                            </div>
                                                        </td>

                                                        <td>
                                                            <div>
                                                                <input type="text" class="form-control" name="week_25" >
                                                            </div>
                                                        </td>
                
                                                        <td>
                                                            <div>
                                                                <input type="text" class="form-control" name="week_26" >
                                                            </div>
                                                        </td>

                                                        <td>
                                                            <div>
                                                                <input type="text" class="form-control" name="week_27" >
                                                            </div>
                                                        </td>
                
                                                        <td>
                                                            <div>
                                                                <input type="text" class="form-control" name="week_28" >
                                                            </div>
                                                        </td>

                                                        <td>
                                                            <div>
                                                                <input type="text" class="form-control" name="week_29" >
                                                            </div>
                                                        </td>
                
                                                        <td>
                                                            <div>
                                                                <input type="text" class="form-control" name="week_30" >
                                                            </div>
                                                        </td>

                                                        <td>
                                                            <div>
                                                                <input type="text" class="form-control" name="week_31" >
                                                            </div>
                                                        </td>
                
                                                        <td>
                                                            <div>
                                                                <input type="text" class="form-control" name="week_32" >
                                                            </div>
                                                        </td>

                                                        <td>
                                                            <div>
                                                                <input type="text" class="form-control" name="week_33" >
                                                            </div>
                                                        </td>
                
                                                        <td>
                                                            <div>
                                                                <input type="text" class="form-control" name="week_34" >
                                                            </div>
                                                        </td>

                                                        <td>
                                                            <div>
                                                                <input type="text" class="form-control" name="week_35" >
                                                            </div>
                                                        </td>
                
                                                        <td>
                                                            <div>
                                                                <input type="text" class="form-control" name="week_36" >
                                                            </div>
                                                        </td>

                                                        <td>
                                                            <div>
                                                                <input type="text" class="form-control" name="week_37">
                                                            </div>
                                                        </td>
                
                                                        <td>
                                                            <div>
                                                                <input type="text" class="form-control" name="week_38">
                                                            </div>
                                                        </td>

                                                        <td>
                                                            <div>
                                                                <input type="text" class="form-control" name="week_39">
                                                            </div>
                                                        </td>
                
                                                        <td>
                                                            <div>
                                                                <input type="text" class="form-control" name="week_40">
                                                            </div>
                                                        </td>

                                                        <td>
                                                            <div>
                                                                <input type="text" class="form-control" name="week_41">
                                                            </div>
                                                        </td>

                                                        <td>
                                                            <div>
                                                                <input type="text" class="form-control" name="week_42">
                                                            </div>
                                                        </td>
                
                                                        <td>
                                                            <div>
                                                                <input type="text" class="form-control" name="week_43">
                                                            </div>
                                                        </td>

                                                        <td>
                                                            <div>
                                                                <input type="text" class="form-control" name="week_44">
                                                            </div>
                                                        </td>
                
                                                        <td>
                                                            <div>
                                                                <input type="text" class="form-control" name="week_45">
                                                            </div>
                                                        </td>

                                                        <td>
                                                            <div>
                                                                <input type="text" class="form-control" name="week_46">
                                                            </div>
                                                        </td>
                
                                                        <td>
                                                            <div>
                                                                <input type="text" class="form-control" name="week_47">
                                                            </div>
                                                        </td>
                                                        
                                                        <td>
                                                            <div>
                                                                <input type="text" class="form-control" name="week_48">
                                                            </div>
                                                        </td>
                
                                                        <td>
                                                            <div>
                                                                <input type="text" class="form-control" name="week_49">
                                                            </div>
                                                        </td>

                                                        <td>
                                                            <div>
                                                                <input type="text" class="form-control" name="week_50">
                                                            </div>
                                                        </td>
                
                                                        <td>
                                                            <div>
                                                                <input type="text" class="form-control" name="week_51">
                                                            </div>
                                                        </td>

                                                        <td>
                                                            <div>
                                                                <input type="text" class="form-control" name="week_52">
                                                            </div>
                                                        </td>
                
                                                        <td>
                                                            <div>
                                                                <input type="text" class="form-control" name="week_53">
                                                            </div>
                                                        </td>
                                                    </tr>
                                                </tbody>
