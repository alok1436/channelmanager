                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="td-field">
                                                            ...
                                                            <div class="field-edit">
                                                                <input type="text" name="shortname" class="form-control" value="{{$row->shortname}}" data-id="{{$row->platformid}}" data-field="shortname">
                                                            </div>
                                                        </td>
                                                        <td class="td-field">
                                                            <span class="field-value">{{$row->longname}}</span>
                                                            <div class="field-edit">
                                                                <input type="text" name="longname" class="form-control" value="{{$row->longname}}" data-id="{{$row->platformid}}" data-field="longname">
                                                            </div>
                                                        </td>
                                                        <!-- <td>
                                                            <a href="platformDelete?del={{$row->platformid}}" class="btn btn-danger">Delete</a>
                                                        </td> -->
                                                    </tr>
                                                @endforeach
                                            </tbody>
