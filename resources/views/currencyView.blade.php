            ...
            <div class="page-wrapper">
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">View currencies available</h3>
                    </div>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <a href="currencyAddView" class="btn btn-info">Add currency</a>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="td-field">
                                                        ...
                                                        <div class="field-edit">
                                                            <input type="text" name="shortname" class="form-control" value="{{$row->shortname}}" data-id="{{$row->currencyid}}" data-field="shortname">
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td class="td-field">
                                                        ...
                                                        <div class="field-edit">
                                                            <input type="text" name="longname" class="form-control" value="{{$row->longname}}" data-id="{{$row->currencyid}}" data-field="longname">
                                                        </div>
                                                    </td>
                                                    
                                                    <td class="td-field">
                                                        <span  class="field-value">{{$row->rate}}</span>
                                                        <div class="field-edit">
                                                            <input type="text" name="rate" class="form-control" value="{{$row->rate}}" data-id="{{$row->currencyid}}" data-field="rate">
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <a href="currencyDelete?del={{$row->currencyid}}" class="btn btn-danger">Delete</a>
                                                    </td>
                                                </tr>
                                                @endforeach
                                            </tbody>
