            ...
            <div class="page-wrapper">
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">Add new country</h3>
                    </div>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <form method="post" enctype="multipart/form-data" action="countryAdd">
                                        {{ csrf_field() }}
                                        <div class="row">
                                        ...
                                        <input type="submit" name="submit" class="btn btn-info" value="Add new country">
                                        <!-- row -->
                                    </form>
                                </div>
                            </div>
