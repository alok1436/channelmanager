            ...
            <div class="page-wrapper">
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">Add new subcategory</h3>
                    </div>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <form method="post" enctype="multipart/form-data" action="subcategoryAdd">
                                        {{ csrf_field() }}
                                        <div class="row">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="category" required="">
                                                        ...
                                                        @foreach($maincategorys as $data)
                                                            <option value="{{$data->catmainid.'!@-'.$data->Namecat}}">{{$data->Namecat}}</option>
                                                        @endforeach
                                                    </select>    
                                                </div>
                                            </div>
                                        </div>
                                        <input type="submit" name="submit" class="btn btn-info" value="Add new subcategory">
                                    </form>
                                </div>
                            </div>
                        </div>
