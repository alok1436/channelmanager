                    ...
                    <div class="navbar-collapse">
                        ...
                        <ul class="navbar-nav my-lg-0">
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark" href="logouti class="fa fa-power-off"></i> Logout</a>
                            </li>
                        </ul>
                    </div>
                </nav>
                        ...
                        <ul id="sidebarnav">
                            ...
                            <li> 
                                ...
                                <ul aria-expanded="false" class="collapse">
                                    ...
                                    <li><a class="" href="channelViewnnel</a></li>
            ...
            <div class="page-wrapper">
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">Add new manufacturer</h3>
                    </div>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <form method="post" action="manufacturerAdd">
                                        {{ csrf_field() }}
                                        <div class="row">
                                            <div class="col-md-7 col-sm-12">
                                                <div class="form-group">
                                                    <label>Short name of the company</label>
                                                    <input type="text" name="shortname" class="form-control"/>
                                                </div>
                                                <div class="form-group">
                                                    <label>Complete name of the company</label>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-4">
                                                            <input type="text" name="contact1" class="form-control" placeholder="Enter Contact 1" />
                                                        </div>
                                                        <div class="col-4">
                                                            <input type="text" name="contact2" class="form-control" placeholder="Enter Contact 2" />
                                                        </div>
                                                        <div class="col-4">
                                                            <input type="text" name="contact3" class="form-control" placeholder="Enter Contact 3" />
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-4">
                                                            <input type="text" name="phone1" class="form-control" placeholder="Enter Phone 1" />
                                                        </div>
                                                        <div class="col-4">
                                                            <input type="text" name="phone2" class="form-control" placeholder="Enter Phone 2" />
                                                        </div>
                                                        <div class="col-4">
                                                            <input type="text" name="phone3" class="form-control" placeholder="Enter Phone 3" />
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-4">
                                                            <input type="email" name="email1" class="form-control" placeholder="Enter Email 1" />
                                                        </div>
                                                        <div class="col-4">
                                                            <input type="email" name="email2" class="form-control" placeholder="Enter Email 2" />
                                                        </div>
                                                        <div class="col-4">
                                                            <input type="email" name="email3" class="form-control" placeholder="Enter Email 3" />
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-4">
                                                            <textarea type="text" name="note1" class="form-control" placeholder="Say Something ..." rows="5"></textarea>
                                                        </div>
                                                        <div class="col-4">
                                                            <textarea type="text" name="note2" class="form-control" placeholder="Say Something ..." rows="5"></textarea>
                                                        </div>
                                                        <div class="col-4">
                                                            <textarea type="text" name="note3" class="form-control" placeholder="Say Something ..." rows="5"></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <input type="submit" name="btn-manu" class="btn btn-info pull-right" value="Add new manufacturer">
                                    </form>
                                </div>
                            </div>
                        </div>
