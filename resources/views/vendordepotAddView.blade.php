            ...
            <div class="page-wrapper">
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">Add product in blacklist Vendor</h3>
                    </div>
                    <div class="col-md-7 align-self-center">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                            <li class="breadcrumb-item">pages</li>
                            <li class="breadcrumb-item active">Vendor Blacklist Add</li>
                        </ol>
                    </div>
                </div>
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <form method="post" enctype="multipart/form-data" action="vendordepotAdd">
                                        {{ csrf_field() }}
                                        <div class="row">
                                            <div class="col-md-5 col-sm-12">
                                                ...
                                                <div class="form-group">
                                                    <label>Region</label>
                                                    <input type="text" class="form-control" id="id_region" name="region">
                                                </div>
                                                <div class="form-group">
                                                    <label>Plz</label>
                                                    <input type="text" class="form-control" id="id_plz" name="plz">
                                                </div>
                                                <div class="form-group">
                                                    <label>Country</label>
                                                    <select name="country" id="id_country" class="form-control">
                                                        ...
                                                        <option value="{{$country->countryid}}">{{$country->longname}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
