            ...
            <div class="page-wrapper">
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">View blacklist</h3>
                    </div>
                                        ...
                                        <table id="myTable" class="table table-striped table-bordered" style="width: 100%;">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{$row->shortname}}</td>
                                                    <td>{{$row->notes}}</td>
                                                    <td><a class="btn btn-danger" href="removeFromBlackList?channelId={{$row->channelId}}&productId={{$row->productid}}">Delete</a></td>
                                                </tr>
                                                @endforeach
                                            </tbody>
                                        </table>
                ...
                <div id="noteforblackListModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="modal-standard-title" aria-hidden="true" style="margin-top:40px;">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <form action="addBlackList" method="POST">
                                {{ csrf_field() }}
                                <div class="modal-body text-center">
                                ...
                                <div class="modal-footer">
                                    <div style="float:left;"><button type="button" class="btn btn-default" data-dismiss="modal">Close</button></div>
                                    <div style="float:right;"><button type="submit" class="btn btn-primary" onClick="funcdeletefrompopup('managedeletepopup');">Add</button></div>
                                    <div style="clear:both;"></div>
                                </div>
                            </form>
                        </div>
