    ...
    <body class="fix-header fix-sidebar card-no-border">
            ...
            <div class="page-wrapper">
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">New orders from the manufacturer</h3>
                    </div>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <form action="sendManufacturerOrder" method="POST">
                                        {{ csrf_field() }}
                                        <div class="col-xs-12 table-responsive">
                                            <table class="table table-striped table-bordered" style="width: 100%;">
                                                <thead>
                                                    <tr>
                                                        <th style="cursor: pointer;" onclick="orderbySort()">Sort 
                                                            @if(Session::has('sortItem') && Session::get('sortItem') == "sort")
                                                        ...
                                                        <th style="cursor: pointer;" onclick="orderbyModelcode()">Model Code 
                                                        ...
                                                        <th style="cursor: pointer;" onclick="orderbyItem()">Item 
                                                            @if(Session::has('sortItem') && Session::get('sortItem') == "nameshort")
                                                                @if(Session::get('sort') == "desc")
                                                                <span><i class="fa fa-caret-down"></i></span>
                                                                @else
                                                                <span><i class="fa fa-caret-up"></i></span>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        @endforeach
                                                        <td><input type="text" class="form-control qty" name="quantity[{{$row->productid}}]" value=""></td>
                                                        <td><input type="text" class="form-control week" name="deliveryweek[{{$row->productid}}]" value="0"></td>
                                                        <td><input type="text" class="form-control notes" name="notes[{{$row->productid}}]" value=""></td>
                                                    </tr>
                                                    @endforeach
                                                </tbody>
                                            </table>
                                        ...
                                        <div class="form-group" style="float: right;">
                                            <input type="submit" name="transfer" value="Confirm arrival of the items" class="btn btn-info">
                                        </div>
                                    </form>
                                </div>
                            </div>
        ...
        <script>
            ...
            function orderbySort() {
                location.href = "manufacturerorderView?sortItem=sort";
            }

            function orderbyModelcode() {
                location.href = "manufacturerorderView?sortItem=modelcode";
            }

            function orderbyItem() {
                location.href = "manufacturerorderView?sortItem=nameshort";
            }
        </script>
