            ...
            <div class="page-wrapper">
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">View Subcategory</h3>
                    </div>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <a href="subcategoryAddView" class="btn btn-info">Add Subcategory</a>
                                        ...
                                        <table id="myTable" class="table table-striped table-bordered" style="width: 100%;">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>{{$row->catsubid}}</td>                    
                                                    <td class="td-field">
                                                        <span  class="field-value">{{$row->Namesubcat}}</span>
                                                        <div class="field-edit">
                                                            <input type="text" name="Namesubcat" class="form-control" value="{{$row->Namesubcat}}" data-id="{{$row->catsubid}}" data-field="Namesubcat">
                                                        </div>
                                                    </td>
                                                    <td class="td-field">
                                                        <span  class="field-value">{{$row->Descriptionsubcat}}</span>
                                                        <div class="field-edit">
                                                            <input type="text" name="Descriptionsubcat" class="form-control" value="{{$row->Descriptionsubcat}}" data-id="{{$row->catsubid}}" data-field="Descriptionsubcat">
                                                        </div>
                                                    </td>
                                                    <td class="td-field">
                                                        <span  class="field-value">{{$row->Namecat}}</span>
                                                        <div class="field-edit">
                                                            <select class="form-control" name="category" required="" data-id="{{$row->catsubid}}" data-field="category">
                                                            <option value="">Select Category</option>
                                                                @foreach($maincategorys as $data)
                                                                    <option value="{{$data->catmainid.'!@-'.$data->Namecat}}" @if($row->catmainid==$data->catmainid) selected="selected" @endif>{{$data->Namecat}}</option>
                                                                @endforeach
                                                            </select>   
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <a href="subcategoryDelete?del={{$row->catsubid}}" class="btn btn-danger">Delete</a>
                                                    </td>
                                                </tr>
                                                @endforeach
                                            </tbody>
