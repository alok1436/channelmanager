            ...
            <div class="page-wrapper">
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">View countries available</h3>
                    </div>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <a href="countryAddView" class="btn btn-info">Add country</a>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="td-field">
                                                        ...
                                                        <div class="field-edit">
                                                            <input type="text" name="shortname" class="form-control" value="{{$row->shortname}}" data-id="{{$row->countryid}}" data-field="shortname">
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td class="td-field">
                                                        ...
                                                        <div class="field-edit">
                                                            <input type="text" name="longname" class="form-control" value="{{$row->longname}}" data-id="{{$row->countryid}}" data-field="longname">
                                                        </div>
                                                    </td>
    
                                                    <td class="td-field">
                                                        <span  class="field-value">{{$row->currency}}</span>
                                                        <div class="field-edit">
                                                            <select class="form-control" name="currency" required="" data-id="{{$row->countryid}}" data-field="currency">
                                                                <option value="">Select Currency</option>
                                                                    @foreach($datafetchcurrency as $data)
                                                                        <option value="{{$data->shortname}}" @if($row->currency==$data->shortname) selected="selected" @endif>{{$data->shortname}}</option>
                                                                    @endforeach
                                                            </select>   
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <a href="countryDelete?del={{$row->countryid}}" class="btn btn-danger">Delete</a>
                                                    </td>
                                                </tr>
                                                @endforeach
                                            </tbody>
