                                    ...
                                    <div class="col-xs-12 table-responsive">
                                        <table id="myTable" class="table table-striped table-bordered" style="width: 100%;">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <?php $num = request()->page > 1 ? (request()->page-1)*100+$i : $i; ?>
                                                    <td>{{$num}}</td>
                                                    <td>{{$row->modelcode}}</td>
                                                    <td>{{$row->nameshort}}</td>
                                                    <td>{{$row->subcat}}</td>
                                                    ...
                                                    @foreach ($warehouses as $key => $w)
                                                        <td class="td-field">
                                                            <span  class="field-value"><?php echo $row->{$w->idwarehouse}; ?></span>
                                                            <div class="field-edit">
                                                                <input type="text" name="warehouse" class="form-control" value="<?php echo $row->{$w->idwarehouse}; ?>" data-old="<?php echo $row->{$w->idwarehouse}; ?>" data-action="update_warehouse" data-id="{{$row->productid}}" data-warehouse="{{$w->idwarehouse}}" data-field="{{$w->idwarehouse}}">
                                                            </div>
                                                        </td>
                                                    @endforeach
                                                    <td>{{$row->total_qty}}</td>
                                                    ...
                                                    <td class="td-field">
                                                        <span  class="field-value">{{$row->dateprice}}</span>
                                                        <div class="field-edit">
                                                        <input type="date" name="dateprice" class="form-control" value="{{$row->dateprice}}" data-id="{{$row->productid}}" data-field="dateprice" style="line-height: 1;">
                                                    </div>
                                                    </td>
                                                    <td>
                                                        <?php 
                                                        ...
                                                        <div class="field-edit">
                                                            <select name="manufacturerid" class="form-control" data-id="{{$row->productid}}" data-field="manufacturerid">
                                                                @foreach ($manufacturers as $key => $m)
                                                                    <option value="{{$m->manufacturerid}}" @if ($m->manufacturerid==$row->manufacturerid) selected="" @endif>
                                                                        {{$m->shortname}}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                    ...
                    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form class="form-inline" action="{{ url('exportQuantity') }}" method="post" id="exportform">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="idwarehouse" id="idwarehouse" class="form-control">
                                        ...
                                        <option value="<?php $res->idwarehouse ?>">{{$res->shortname}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                </form>
