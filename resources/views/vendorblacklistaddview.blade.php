                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <form method="post" enctype="multipart/form-data" action="vendorblacklistadd">
                                        {{ csrf_field() }}
                                        <div class="row">
                                            <div class="col-md-5 col-sm-12">
                                                <div class="form-group">
                                                    <label>EAN code</label>
                                                    <select name="ean" id="id_product_ean" class="form-control">
                                                        <option value="">Select Product</option>
                                                        @foreach($products as $product)
                                                        <option value="{{$product->ean}}">{{$product->ean}} - {{$product->sku}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                <div class="form-group">
