                                    ...
                                    if(!empty($reports)) {
                                        foreach($reports as $report) {
                                            if(isset($report['seller-sku'])) {
                                                ...
                                                $asinorean  = $report['product-id'];
                                                $sku        = $report['seller-sku'];
                                                $fulfillmentchannel        = $report['fulfillment-channel'];
                                                ...
                                                if($result->num_rows > 0) {
                                                    ...
                                                    if ($result->num_rows > 0) {
                                                        ...
                                                        if($fulfillmentchannel == 'AMAZON'){
                                                            $sql    = "UPDATE prices SET online_quentity= 0, last_update_qty_date='".date('Y-m-d H:i:s')."', ebayActive=1 ,updated_date='".date('Y-m-d H:i:s')."' WHERE channel_id=".$channel_data->idchannel." AND country='".$country."' AND sku='".$sku."'";
                                                        }else{
